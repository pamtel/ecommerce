        ...
        <div className="B-payment">
            ...
            <div className="fontWeight">
                <div className="line-height">
                    <h6 className="color-darkslategray">Earing and Mangtikka</h6>
                    <p>Per piece</p>
                </div>
            ...
            <div className="fontWeight">
                ...
                <div className="d-flex justify-content-between pb-3 pt-2">
                    ...
                    <div className="d-flex border-skyblue rounded pb-0 counter color-darkslategray">
                        <span onClick={decreaseCount} className="px-2 color-skyblue bg-lavender fontWeight">-</span>
                        <span  className="px-2 fontWeight">{count}</span>
                        <span onClick={increaseCount} className="px-2 color-skyblue bg-lavender fontWeight">+</span>
                    </div>
                </div>
            </div>
            ...
            <p className="mediumseagreen">You are about to save UGX 27,400 on this order</p>
        </div>
    )
}
