              ...
              <div className="pt-3 ps-4 col-sm-7">
                ...
                <div className="line-height mb-4 fontWeight">
                  <div className="d-flex align-items-center">
                    ...
                    <p className="bg-indiared px-1 py-2 text-white rounded">
                      -20%
                    </p>
                  </div>
                  <sup className="outdated-price color-darkgray">
                    {data.outdated}
                  </sup>
                </div>
                ...
                <div className="d-flex justify-content-between justify-content-sm-start items-detail">
                  <Link to="/bag" className="text-decoration-none">
                    <Button
                      onClick={() => {addToLocalStorage(data); setOpen(true)}}
                      variant="outlined"
                      className="me-4 border-royal-blue border-3 px-3 px-sm-5 py-2 color-royal-blue fontWeight"
                    >
                      Add to bag
                    </Button>
                  </Link>
